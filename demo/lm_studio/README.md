...
1. Client-side validation (Anchor rules only)
2. Server-side validation (Anchor + company rules)
3. Report generation
...
🔍 Auditing Model: demo_model.gguf
   Format: gguf
   ✅ MODEL-001: Training Data Provenance Required (Anchor)
   ✅ MODEL-002: Model Size Limits (Anchor)
...
APPROVE - All Anchor and company policies satisfied.
```
...
> "Client validates against Anchor rules. Server adds company-specific rules. Two layers of security."
